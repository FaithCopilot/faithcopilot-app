...
const columnItems = [
  ...
  { accessor: "service", header: "Service", size: 50 },
  { accessor: "createdAt", header: "Created", size: 75 },
  { accessor: "createdBy", header: "Created By", size: 75 },
];
...
const Policies = () => {
  ...
  data = [
    ...
    {
      name: "Context: Semantic Search (RO)",
      type: "user",
      service: "context",
      createdAt: "202405-29T13:30:00Z",
      createdBy: "zdmc23",
    },
  ]
  ...
  const actionItems = (item, idx) => [
    {
      icon: <Trash2Icon />,
      label: "Delete Policy",
      onClick: () => console.log("*** DELETE POLICY: ", item)
/*
