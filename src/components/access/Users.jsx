...
const columnItems = [
  ...
  { accessor: "type", header: "Type", size: 50 },
  { accessor: "lastModifiedAt", header: "Last Activity", size: 75 },
  { accessor: "lastSignIn", header: "Last Sign-in", size: 75 },
  ...
  data = [
    {
      name: "zdmc23",
      type: "user",
      lastModifiedAt: "2024-04-01T12:00:00Z",
      lastSignIn: "2024-04-01T12:00:00Z",
      createdAt: "2023-08-21T16:45:00Z",
    },
    {
      name: "chatbot 25",
      type: "service",
      lastModifiedAt: "2024-01-02T12:15:00Z",
      lastSignIn: null,
    ...
    },
    {
      name: "jane.doe",
      type: "user",
      lastModifiedAt: "2024-05-17T10:15:00Z",
      lastSignIn: "2024-05-17T10:15:00Z",
      createdAt: "2024-01-23T17:25:00Z",
    },
    {
      name: "Worker Bee",
      type: "agent",
      lastModifiedAt: "2024-06-14T08:45:00Z",
      lastSignIn: null,
  ...
  const actionItems = (item, idx) => [
    {
      icon: <Trash2Icon />,
      label: "Remove User",
      onClick: () => console.log("*** REMOVE USER: ", item)
/*
